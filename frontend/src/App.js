    ...
    <div className="auth-screen">
      ...
      <div className="auth-left">
        <div className="auth-left-top">
          <Logo />
          <span className="auth-left-brand">FitCoach</span>
        </div>
      ...
      <div className="auth-right">
        <div className="auth-card">
          <div>
            <p className="auth-card-title">Get started</p>
            <p className="auth-card-sub">Sign in to access your personal fitness coach.</p>
          </div>
