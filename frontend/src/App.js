  ...
  if (!user) return (
    <div className="landing">
      ...
      <nav className="landing-nav">
        <div className="landing-nav-inner">
          <div className="landing-brand">
            <Logo />
            <span className="landing-brand-name">FitCoach</span>
          </div>
          <button className="landing-nav-btn" onClick={signInWithGoogle}>
            <GoogleIcon />
            Sign in
          </button>
        </div>
      ...
      <div className="landing-hero">
        <p className="landing-eyebrow">AI Fitness Coach</p>
        <h1 className="landing-title">Your workouts,<br /><strong>remembered.</strong></h1>
        <p className="landing-sub">
          Log workouts in plain English. Ask anything about your history.<br />
          Answers grounded in your real data, not generic advice.
        </p>
        <button className="btn-google landing-cta" onClick={signInWithGoogle}>
          <GoogleIcon />
          Continue with Google
        </button>
        <p className="landing-legal">Free to use · Your data is private and only visible to you.</p>
      </div>

      {/* Feature cards */}
      <div className="landing-features">
        <div className="landing-feature-card">
          <span className="landing-feature-tag">Log</span>
          <h3 className="landing-feature-title">Plain English logging</h3>
          <p className="landing-feature-body">No dropdowns or forms. Just describe your workout the way you'd tell a friend — the AI handles the rest.</p>
        </div>
        <div className="landing-feature-card">
          <span className="landing-feature-tag">Ask</span>
          <h3 className="landing-feature-title">Natural language queries</h3>
          <p className="landing-feature-body">Ask anything — "When did I first bench 80kg?" or "How has my cardio pace changed?" and get a real answer.</p>
        </div>
        <div className="landing-feature-card">
          <span className="landing-feature-tag">AI</span>
          <h3 className="landing-feature-title">Built on real retrieval</h3>
          <p className="landing-feature-body">Hybrid search, cross-encoder reranking, and a recursive reasoning loop — not a chatbot guessing at your history.</p>
        </div>
      </div>
